    ...
    <>
      ...
      <div className="min-h-screen font-sans text-slate-800 bg-white">
        ...
        <footer className="mt-10 border-t border-[#D9E7FF]/70 bg-white">
         ...
         <a href="https://www.instagram.com/goldenvacays/" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram" className="text-slate-600 hover:text-[#0057D9] transition">
        ...
        <a href="https://www.facebook.com/goldenvacays/" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook" className="text-slate-600 hover:text-[#0057D9] transition">
